...
#    print(self.W2)
  ...
  def forward(self, X):
    ...
    self.z3 = np.dot(self.a1, self.W2) # dot product of hidden layer (z2) and second set of 3x1 weights
  ...
  def backward(self, X, y, o):
    ...
    self.a1_error = self.o_delta.dot(self.W2.T) # a1 error: how much our hidden layer weights contributed to output error
